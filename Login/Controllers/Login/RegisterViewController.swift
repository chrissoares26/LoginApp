...
class RegisterViewController: UIViewController {
    ...
    @objc private func registerButtonTapped(){
        ...
        DatabaseManager.shared.userExists(with: email, completion: { [weak self] exists in
            ...
            guard !exists else {
                strongSelf.alertUserLoginError(message: "Looks like an user account for that email already exists")
                return
            }
    ...
    func alertUserLoginError(message: String = "Please enter all the information needed"){
